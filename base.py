...
def cube_create(scale, name="cube_create", location=(0, 0, 0), rotation=(0, 0, 0)):
...
def cube_add(target, scale, name="cube_add", location=(0, 0, 0), rotation=(0, 0, 0)):
...
def cube_clear(target, scale, name="cube_clear", location=(0, 0, 0), rotation=(0, 0, 0)):
    bpy.ops.mesh.primitive_cube_add(size=1, scale=scale, location=location, rotation=rotation)
    modifier_apply(target=target, obj=bpy.context.active_object, name=name, operation="DIFFERENCE")

def cube_cut(target, scale, name="cube_cut", location=(0, 0, 0), rotation=(0, 0, 0)):  # alias
...
def frame_add(target, inner, thickness, name="frame_add", location=(0, 0, 0), rotation=(0, 0, 0)):
...
def cylinder_create(radius, depth, name="cylinder_create", location=(0, 0, 0), rotation=(0, 0, 0), vertices=32):
...
def cylinder_add(target, radius, depth, name="cylinder_add", location=(0, 0, 0), rotation=(0, 0, 0), vertices=32):
    bpy.ops.mesh.primitive_cylinder_add(radius=radius, depth=depth, location=location, rotation=rotation, vertices=vertices)
    modifier_apply(target=target, obj=bpy.context.active_object, name=name, operation="UNION")

def cylinder_clear(target, radius, depth, name="cylinder_clear", location=(0, 0, 0), rotation=(0, 0, 0), vertices=32):
    bpy.ops.mesh.primitive_cylinder_add(radius=radius, depth=depth, location=location, rotation=rotation, vertices=vertices)
    modifier_apply(target=target, obj=bpy.context.active_object, name=name, operation="DIFFERENCE")

def cylinder_cut(target, radius, depth, name="cylinder_cut", location=(0, 0, 0), rotation=(0, 0, 0), vertices=32):  # alias
    cylinder_clear(target=target, radius=radius, depth=depth, name=name, location=location, rotation=rotation, vertices=vertices)

def mount_pins(target, radius, depth, pins, name="mount_pins", height_pos=0, rotation=(0, 0, 0), vertices=32):
...
def punch_holes(target, radius, depth, holes, name="punch_holes", height_pos=0, rotation=(0, 0, 0), vertices=32):
...
def ring_add(target, outer_radius, inner_radius, depth, name="ring_add", gap=1, location=(0, 0, 0), rotation=(0, 0, 0), vertices=32):
...
def hexagon_add(target, radius, depth, location, name="hexagon_add", rotation=(0, 0, 0)):
    bpy.ops.mesh.primitive_cylinder_add(radius=radius, depth=depth, vertices=6, location=location, rotation=rotation)
    modifier_apply(target=target, obj=bpy.context.active_object, name=name, operation="UNION")

def hexagon_clear(target, radius, depth, location, name="hexagon_clear", rotation=(0, 0, 0)):
    bpy.ops.mesh.primitive_cylinder_add(radius=radius, depth=depth, vertices=6, location=location, rotation=rotation)
    modifier_apply(target=target, obj=bpy.context.active_object, name=name, operation="DIFFERENCE")

def hexagon_cut(target, radius, depth, location, name="hexagon_cut", rotation=(0, 0, 0)):  # alias
    hexagon_clear(target=target, radius=radius, depth=depth, location=location, name=name, rotation=rotation)

# === triangle ===========

def _triangle_apply(vertices, depth, location, rotation=(0, 0, 0)):
...
def triangle_add(target, vertices, depth, name="triangle_add", location=(0, 0, 0), rotation=(0, 0, 0)):

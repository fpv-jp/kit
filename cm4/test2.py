...
height1 = 35
width1 = 59.5
width3 = BASE_PLATE_HEIGHT / 4

add_protrusion_to_object(
    hexagonal_plate,
    protrusion_name="UpperArmRight",
    dimensions=(2, BASE_PLATE_HEIGHT, height1),
    position=(
...
add_protrusion_to_object(
    hexagonal_plate,
    protrusion_name="UpperArmRight",
    dimensions=(2, width3, height1),
    position=(
        10,
        width3 + BASE_PLATE_THICKNESS,
        height1 / 2 + 1,
    ),
)
add_protrusion_to_object(
...
# -------------------------------
x_pos = width1 / 2 - BASE_PLATE_THICKNESS / 2
add_angled_cut_to_protrusion(
    hexagonal_plate,
    cut_name="UpperCornerCut",
    cut_dimensions=(5, 40, 46),
    cut_position=(
        x_pos,
        -26,
        31,
    ),
    cut_rotation=(math.radians(-30), 0, 0),
)
add_angled_cut_to_protrusion(
    hexagonal_plate,
    cut_name="UpperCornerCut",
    cut_dimensions=(5, 8, 26),
    cut_position=(
        x_pos,
        -1,
        19,
...
add_angled_cut_to_protrusion(
    hexagonal_plate,
    cut_name="UpperCornerCut",
    cut_dimensions=(5, 15, 30),
    cut_position=(
        -10,
        3,
        24,
    ),
    cut_rotation=(math.radians(-20), 0, 0),
)
add_angled_cut_to_protrusion(
    hexagonal_plate,
    cut_name="UpperCornerCut",
...
add_protrusion_to_object(
    ...
    position=(
        0,
        BASE_PLATE_HEIGHT / 2 - BASE_PLATE_THICKNESS / 2,
        height1 / 2 + BASE_PLATE_THICKNESS / 2,
    ),
)
...
add_protrusion_to_object(
    ...
    position=(
        0,
        -BASE_PLATE_HEIGHT / 2 + BASE_PLATE_THICKNESS / 2,
        height2 / 2 + BASE_PLATE_THICKNESS / 2,
    ),
)
add_protrusion_to_object(
    hexagonal_plate,
...
rect_hole = create_cube(
    "Rect_Hole2", 1, (0, 16, width1 / 3 - 1), (width4 + 1, 6, height4)
)
...
rect_hole = create_cube(
    "Rect_Hole2", 1, (19.5, 16, width1 / 3 - 1), (width4, 6, height4)
)
apply_boolean_modifier(hexagonal_plate, rect_hole, "DIFFERENCE", "Bool_Rect_Hole")
bpy.data.objects.remove(rect_hole, do_unlink=True)
...
rect_hole = create_cube("Rect_Hole2", 1, (30, 6.5, 18.5), (10, 9, 27.5))
apply_boolean_modifier(hexagonal_plate, rect_hole, "DIFFERENCE", "Bool_Rect_Hole")
bpy.data.objects.remove(rect_hole, do_unlink=True)
rect_hole = create_cube("Rect_Hole2", 1, (30, 0, 7.25), (10, 22, 5))
apply_boolean_modifier(hexagonal_plate, rect_hole, "DIFFERENCE", "Bool_Rect_Hole")
bpy.data.objects.remove(rect_hole, do_unlink=True)
rect_hole = create_cube("Rect_Hole2", 1, (30, 0, 12), (10, 10, 10))
apply_boolean_modifier(hexagonal_plate, rect_hole, "DIFFERENCE", "Bool_Rect_Hole")
bpy.data.objects.remove(rect_hole, do_unlink=True)

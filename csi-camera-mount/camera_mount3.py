...
arm_position_x = (plate_width + plate_depth) / 2
...
primitive_cube_add(
    ...
    location=(arm_position_x, gap_y, (arm_height - plate_depth) / 2),
)
...
primitive_cylinder_add(
    ...
    radius=M2,
    depth=plate_depth + 1,
    location=(arm_position_x, arm_width / 2 - hole_gap + gap_y, arm_height / 2.5),
